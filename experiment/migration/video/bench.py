...
def main():
    ...
    parser.add_argument('--cameras', type=int, default=64, help='摄像头数量')
    parser.add_argument('--fps', type=int, default=30, help='每路帧率')
    parser.add_argument('--hotspot-ratio', type=float, default=0.5, help='热点摄像头比例（0-1）')
    parser.add_argument('--cache-ttl', type=int, default=90, help='缓存TTL（秒）')
    parser.add_argument('--track-duration', type=int, default=90, help='追踪状态保留时长（秒）')
